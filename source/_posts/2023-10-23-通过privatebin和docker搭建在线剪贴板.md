...
不要用国内服务器，不要用国内服务器。除非你喜欢备案

{% endnote %}

![苦笑.jpg](https://blog-pic-storage.oss-cn-shanghai.aliyuncs.com/img/202310270926131.png)
...
![申请证书](https://blog-pic-storage.oss-cn-shanghai.aliyuncs.com/img/202310270938576.png)

开启代理，代理到本地相应端口。

![settings](https://blog-pic-storage.oss-cn-shanghai.aliyuncs.com/img/202310270934342.png)

![reproxy](https://blog-pic-storage.oss-cn-shanghai.aliyuncs.com/img/202310270933231.png)

用绑定的域名访问就可以正常使用了

![done！](https://blog-pic-storage.oss-cn-shanghai.aliyuncs.com/img/202310270940225.png)

## 自定义配置

以下是`conf.php`文件的内容，可根据需要更改。

此文件需要存放于刚才配置的`config`目录。

![config](https://blog-pic-storage.oss-cn-shanghai.aliyuncs.com/img/202310270943503.png)
...
[^1]:[Docker · PrivateBin/PrivateBin Wiki (github.com)](https://github.com/PrivateBin/PrivateBin/wiki/Docker)
[^2]:[协同工作之代码分享PrivateBin | 老苏的blog (laosu.cf)](https://laosu.cf/2020/11/30/协同工作之代码分享PrivateBin/)
